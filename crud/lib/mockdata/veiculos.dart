...
const VEICULOS_MOCK = const [
  Veiculos(
      ...
      valor: 72007.00,
      imagem:
          'https://cdn-motorshow-ssl.akamaized.net/wp-content/uploads/sites/2/2020/12/volkswagen-amarok-v6-2021-13_800x597.jpg'),
  Veiculos(
      id: 'fusca',
      id_montadora: 'vw',
      ...
      imagem:
          'https://i0.statig.com.br/bancodeimagens/7q/3z/mi/7q3zmifgy7zuknlwyldbuawbu.jpg'),
  Veiculos(
      id: 'uno',
      id_montadora: 'ft',
